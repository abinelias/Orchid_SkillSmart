...
namespace SkillSmartWebAPI.Controllers
{
    public class EmployerMessageController : ApiController
    {
        ...
        public IEnumerable<EmployerMessage> GetAllJobSeekerMessages(String jobSeekerId)
        {
            return ServiceFactory.GetEmployerMessages().GetAllEmployerMessages(jobSeekerId);
        }
