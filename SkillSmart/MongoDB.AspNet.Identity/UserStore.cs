...
namespace MongoDB.AspNet.Identity
{
      ...
      where TUser : IdentityUser
  {
    ...
    /// <summary>
    /// The authorized users collection name
    /// </summary>
    private const string collectionName = "AuthUsers";
    ...
    public UserStore(string connectionNameOrUrl)
    {
      ...
      {
        db = DatabaseFactory.CreateMongoDatabase(); // GetDatabase(connectionNameOrUrl, "AuthUsers");
      ...
      else
      {
        ...
        {
          db = GetDatabase(connStringFromManager, "AuthUsers");
